    ...
    return (
        <Frame width={width} height={height} flexDirection="column">
            ...
            >
                ...
                <Flex width="100%" height="100%" justifyContent="center" fontSize="12px" color="white">
                    <Flex>Window Text</Flex>
                </Flex>
            </Flex>
            <Flex height="100%" width="100%" borderRadius={`0 0 ${borderRadius} ${borderRadius}`} overflowY="auto">
                {children}
            </Flex>
        </Frame>
    );
